...
<section class="p-tb-40">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="heading">
                    <h4 class="mb-3"><b class="c-bb-1p">Institutional Apparel</b></h4>
                    <p class="mb-5">
        ...
        <div class="row gx-3">
            <div class="col-12 col-md-3">
                <a class="r-ul" href="{{ url('/listing') }}">
                    <img class="img-fluid" src="{{ asset('images/institutional-apparel-image-banner.jpg') }}" alt="Snow">
                </a>
            </div>
                    ...
                    <div class="col-12 col-md-3">
                        <div class="c-light-grey-broder">
                            <a href="{{ url('/details') }}" class="r-ul txt-black" target="_blank">
                                <img class="img-gluid img-height" width="100%" src="{{ asset('images/institutional-apparel-image'.$i.'.jpg') }}">

                                <div class="p-3 txt-black">
                                    <h5 class="mt-3 f-16p primary-color"><b>Cloth {{ $i }}</b></h5>
