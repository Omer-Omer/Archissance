...
<section class="p-tb-40">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="heading">
                    <h4 class="mb-3"><b class="c-bb-1p">Womens Party Wear Clothing</b></h4>
                    <p class="mb-5">
        ...
        <div class="row gx-3">
            <div class="col-12 col-md-3">
                <a class="r-ul" href="{{ url('/listing') }}">
                    <img class="img-fluid" src="{{ asset('images/party-wear-image-banner.jpg') }}" alt="Snow">
                </a>
            </div>
                    ...
                    <div class="col-12 col-md-3">
                        <div class="c-light-grey-broder">
                            <a href="{{ url('/details') }}" class="r-ul txt-black" target="_blank">
                                <img class="img-gluid img-height" width="100%" src="{{ asset('images/party-wear-image'.$i.'.jpg') }}">
