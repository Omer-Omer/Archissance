                  ...
                  <div class="row">
                     <div class="col-lg-12">
                        ...
                        <div class="mb-4">
                           ...
                           <input type="text" class="form-control" id="redirect_url" name="redirect_url" @if(isset($pageMeta['redirect_url'])) value="{{ $pageMeta['redirect_url'] }}" @endif>
                        </div>
                        <!-- End of Form -->
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-lg-12">
                        ...
                        <div class="mb-4">
                           ...
                           <input type="text" class="form-control" id="redirection_time" name="redirection_time" @if(isset($pageMeta['redirection_time'])) value="{{ $pageMeta['redirection_time'] }}" @endif>
                        </div>
                        <!-- End of Form -->
                     </div>
                  </div>
