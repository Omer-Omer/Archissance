    ...
    <div style="margin-top: 50px;">
        <div class="row">
            ...
            <div class="col-12 mb-4">
                <form id="form-submit" action="{{ route('home.banner.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="form-check form-switch">
                                                <label class="form-check-label" for="status">Statue
                                                    Active/Inactive</label>
                                                <input class="form-check-input" type="checkbox" name="status"
                                                    id="status" {{ old('status') ? 'checked' : '' }} checked>
                                            </div>
                                            <!-- End of Form -->
                                        </div>
                                    </div>
