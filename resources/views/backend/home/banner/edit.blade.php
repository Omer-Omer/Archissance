    ...
    <div style="margin-top: 50px;">
        <div class="row">
            ...
            <div class="col-12 mb-4">
                <form id="form-submit"  action="{{ route('home.banner.update', $banner->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="card-body">
                            <div class="row mb-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <img width="25%" src="{{ $banner->getFirstMediaUrl('homeBannerImages') }}" alt="Image">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="form-check form-switch">
                                            ...
                                            <input class="form-check-input" type="checkbox" name="status" id="status"
                                                {{ old('status', $banner->status) ? 'checked' : '' }} checked>
                                        </div>
                                        <!-- End of Form -->
                                    </div>
                                </div>
        ...
        $(document).ready(function() {
            ...
            $('#form-submit').on('submit', function(e) {
                ...
                pond.getFiles().forEach(function (file) {
                    formData.append('image', file.file); // Append each file from FilePond to formData
                });
