                  ...
                  <div class="row">
                     <div class="col-lg-4 col-sm-6">
                        ...
                        <div class="mb-4">
                           ...
                           <input type="text" class="form-control" name="starting_fee" value="{{ $university->starting_fee }}">
                        </div>
                        <!-- End of Form -->
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-lg-4 col-sm-6">
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-select" multiple aria-label="multiple select example" name="entrance_type[]">
                                <option value="Summer" @if(is_array($university['entrance_type']) && in_array('Summer', $university['entrance_type'])) selected @endif>Summer</option>
                                <option value="Spring" @if(is_array($university['entrance_type']) && in_array('Spring', $university['entrance_type'])) selected @endif>Spring</option>
                                <option value="Fall" @if(is_array($university['entrance_type']) && in_array('Fall', $university['entrance_type'])) selected @endif>Fall</option>
                            </select>
                        </div>
                        <!-- End of Form -->
                     </div>
                     ...
                     <div class="col-lg-4 col-sm-6">
                        ...
                        <label for="deadline">Dead Line</label>
                            <div class="input-group">
                                ...
                                <input data-datepicker="" class="form-control" type="text" placeholder="dd/mm/yyyy" name="deadline" value="{{ $university->deadline }}">
                            </div>
                        </div>
                        <!-- End of Form -->
                     </div>
                  ...
                  <div class="row">
                     <div class="col-lg-4 col-sm-6">
                        ...
                        <div class="mb-4">
                           ...
                           <input type="text" class="form-control" name="min_gpa" value="{{ $university->min_gpa }}">
                        </div>
                        <!-- End of Form -->
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-lg-4 col-sm-6">
                        ...
                        <div class="mb-4">
                           ...
                           <input type="text" class="form-control" name="min_ielts" value="{{ $university->min_ielts }}">
                        </div>
                        <!-- End of Form -->
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-lg-4 col-sm-6">
                        ...
                        <div class="mb-4">
                           ...
                           <input type="text" class="form-control" name="min_toefl" value="{{ $university->min_toefl }}">
                        </div>
                        <!-- End of Form -->
                     </div>
                  </div>
                        ...
                        <div class="mb-4">
                           <label for="scholarships">Scholarships</label>
                            <select class="form-select" aria-label="Default select example" name="scholarships">
                                ...
                                <option value="1" @if($university->scholarships == 1) selected @endif>Yes</option>
                                <option value="0" @if($university->scholarships == 0) selected @endif>No</option>
                            </select>
                        </div>
                        <!-- End of Form -->
                     </div>
                  ...
                  <div class="row">
                     <div class="col-lg-4 col-sm-6">
                        ...
                        <div class="mb-4">
                           ...
                           <input type="text" class="form-control" name="local_rank" value="{{ $university->local_rank }}">
                        </div>
                        <!-- End of Form -->
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-lg-4 col-sm-6">
                        ...
                        <div class="mb-4">
                           ...
                           <input type="text" class="form-control" name="qs_rank" value="{{ $university->qs_rank }}">
                        </div>
                        <!-- End of Form -->
                     </div>
                  </div>
                        ...
                        <div class="mb-4">
                              ...
                              <select class="form-select" aria-label="Default select example" name="state_id" id="state-dropdown" data-url="{{ route('getCities') }}">
                                 ...
                                 @foreach($states as $state)
                                    <option value="{{ $state['id'] }}" @if($state['id'] == $university->state_id) selected @endif>{{ $state['name'] }}</option>
                                 @endforeach
                                 @if(count($states) === 0)
                  ...
                  <div class="row">
                     <div class="col-lg-4 col-sm-6">
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-select" multiple aria-label="multiple select example" name="colleges[]">
                                @forelse ($colleges as $college)
                                    <option value="{{ $college['id'] }}" @if(in_array($college['id'], $university->colleges->pluck('id')->toArray())) selected @endif>{{ $college['name'] }}</option>
                                @empty
                  ...
                  <div class="row">
                     <div class="col-lg-4 col-sm-6">
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-select" multiple aria-label="multiple select example" name="foundation_programs[]">
                                @forelse ($foundationPrograms as $val)
                                    <option value="{{ $val['id'] }}" @if(in_array($val['id'], $university->foundationPrograms->pluck('id')->toArray())) selected @endif>{{ $val['name'] }}</option>
                                @empty
                  ...
                  <div class="row">
                     <div class="col-lg-4 col-sm-6">
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-select" multiple aria-label="multiple select example" name="ug_programs[]">
                                @forelse ($ugPrograms as $val)
                                    <option value="{{ $val['id'] }}" @if(in_array($val['id'], $university->ugPrograms->pluck('id')->toArray())) selected @endif>{{ $val['name'] }}</option>
                                @empty
                                    <option value="" disabled>No foundation programs available</option>
                                @endforelse
                            </select>
                  ...
                  <div class="row">
                     <div class="col-lg-4 col-sm-6">
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-select" multiple aria-label="multiple select example" name="pg_programs[]">
                                @forelse ($pgPrograms as $val)
                                    <option value="{{ $val['id'] }}" @if(in_array($val['id'], $university->pgPrograms->pluck('id')->toArray())) selected @endif>{{ $val['name'] }}</option>
                                @empty
