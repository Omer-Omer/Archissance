...
<div class="container">
   ...
   <table id="categories-table" style="border-top: 1px solid rgb(128 128 128 / 17%);" class="table table-bordered">
      <thead>
         <tr>
            <th>ID</th>
            <th>Name</th>
...
<script>
   ...
   $('#categories-table').on('click', '.edit-btn', function () {
        ...
        window.location.href = "{{ route('categories.edit', ['category' => 'category_id_placeholder']) }}".replace('category_id_placeholder', categoryId);
   });
