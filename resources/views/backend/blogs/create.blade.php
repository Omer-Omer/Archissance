                        ...
                        <div class="row mb-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control" id="image_alt_tag"
                                            name="image_alt_tag" value="{{ old('image_alt_tag') }}">
                                    </div>
                                    <!-- End of Form -->
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <span class="required">*</span>
                                        <select class="form-select" aria-label="Default select" name="user_id"
                                            id="user_id">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <!-- Form -->
                                    <div class="form-check form-switch">
                                        <label class="form-check-label" for="comments display">Comment
                                            Disallow/Allow</label>
                                        <input class="form-check-input" type="checkbox" name="comments_display"
                                            id="comments_display" {{ old('comments_display') ? 'checked' : '' }} checked>
                                    </div>
                                    <!-- End of Form -->
                                </div>
                            </div>
                            <div class="row">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input class="form-control date-picker" id="created_at" type="text"
                                        name="created_date" placeholder="dd/mm/yyyy" value={{ old('created_date') }}>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input class="form-control date-picker" id="updated_date" type="text"
                                            name="updated_date" placeholder="dd/mm/yyyy" value={{ old('updated_date') }}>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea class="form-control" placeholder="Enter og description" name="og_description" id="og_description"
                                            rows="4">{{ old('og_description') }}</textarea>
                                    </div>
                                    <!-- End of Form -->
                                </div>
                            </div>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea class="form-control" placeholder="Enter twitter description..." name="twitter_description" id="twitter_description"
                                            rows="4">{{ old('twitter_description') }}</textarea>
                                    </div>
                                    <!-- End of Form -->
                                </div>
                            </div>
...
@push('footer-js')
    ...
    {{-- <script src="{{ asset('frontend/js/uploadAdapter.js') }}"></script> --}}

    {{-- <script src="https://cdn.ckeditor.com/ckeditor5/36.0.1/classic/ckeditor.js"></script> --}}

    {{-- <script>
        const uploadImageUrl = "{{ url('/admin/upload-image') }}"; // Set the URL from Blade
        ...
        class UploadAdapter {
            ...
            upload() {
                return new Promise((resolve, reject) => {
                    ...
                    data.append('file', this.loader.file); // Ensure the file field name matches
