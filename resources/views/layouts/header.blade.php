...
<nav class="navbar navbar-expand-lg bg-white fixed-top navbar-light p-1">
    <div class="container">
        ...
        <div class=" collapse navbar-collapse" id="navbarNavDropdown">
            <div class="ms-auto d-none d-lg-block">
                ...
                <a class="nav-link mx-2 text- txt-black" href="#" style="    font-size: 20px;
                text-decoration: underline;">Pakistan's Top Apparel Manufacturers</a>
            </div>
            <ul class="navbar-nav ms-auto ">
                ...
                <li class="nav-item">
                    <a class="nav-link mx-2 text-uppercase" href="#">Buyers</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link mx-2 text-uppercase" href="#">Suppliers</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link mx-2 text-uppercase" href="#">Services</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link mx-2 text-uppercase" href="#">About Us</a>
                </li>
            </ul>
            {{-- <ul class="navbar-nav ms-auto ">
                <li class="nav-item">
